...
public class Grapevine extends Entity {
    ...
    public Grapevine(Level level, int tx, int ty) {
    ...
    public void update(float deltaTime) {
        ...
        if (growTimer > 5 && growTimer < 6 && canHarvest()) {
            ...
            for (int i = 0; i < count; i++) {
                getLevel().add(getLevel(), new PickupItem(getLevel(), new ResourceItem(Resources.potato), new Vector2(getPosition().x, getPosition().y)));
            }
