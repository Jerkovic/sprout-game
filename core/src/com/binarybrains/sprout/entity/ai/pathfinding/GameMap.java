...
public class GameMap implements TileBasedMap {
	...
	public GameMap() {
		...
		fillArea(8,12,7,1,WATER);
		fillArea(7,16,22,4,WATER);
		...
		fillArea(12,12,7,3,TREES);
		fillArea(22,1,2,3,TREES);
	...
	public boolean blocked(Mover mover, int x, int y) {
		// if theres a unit/other entity at the location, then it's blocked
